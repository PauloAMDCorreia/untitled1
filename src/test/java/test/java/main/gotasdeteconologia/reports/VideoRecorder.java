package test.java.main.gotasdeteconologia.reports;
...
public class VideoRecorder extends ScreenRecorder {
    ...
    protected File createMovieFile(Format fileFormat) throws java.io.IOException {
        ...
        return new File(movieFolder, name + "-" + System.currentTimeMillis() + "." + Registry.getInstance().getExtension(fileFormat));
    }
